...
file_info = [
    ("results_10k_flower.pkl", "10 k sample, p=0.5"),
    ("results_100k_flower.pkl", "100 k sample, p=0.5"),
]

# file_info = [
#     ("results_10k_unimode.pkl", "10 k sample, p=0.5"),
#     ("results_100k_unimode.pkl", "100 k sample, p=0.5"),
# ]

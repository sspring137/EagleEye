...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 23 09:02:50 2025
...
def generate_uniform_with_Gaussian_ove_under(n_dim, num_points, anomaly_sizes_o, anomaly_sizes_u):
    # Generate the points
    ...
    return reference_data, data_with_anomaly

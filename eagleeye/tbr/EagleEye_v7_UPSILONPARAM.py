...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def Soar(reference_data, test_data, result_dict_in={}, K_M=1000, critical_quantiles=None, Upsilon_stars=None, num_cores=1, validation=None, partition_size=100,smoothing=3):
    print("Eagle...Soar!")
    print(r"""
                               /T /I
                              / |/ | .-~/
...
""", end='')
    ...
    if critical_quantiles is not None:
        ...
        # At the moment only able to hard code in one set of upslon stars for plus and minus 
        print("User specifed Upsilon_stars stars: Warning! Upsilon_stars can correspond to different quantiles for plus/minus! ")
        Upsilon_star_plus  = Upsilon_stars
        Upsilon_star_minus = Upsilon_stars
